...
from controllers import AgreementsControllergreements
...
def register_routes(app: FastAPI):
    ...
    app.include_router( CapacityAssessmentsController.router , dependencies=auth_dependency)
    AgreementsControllergreements
