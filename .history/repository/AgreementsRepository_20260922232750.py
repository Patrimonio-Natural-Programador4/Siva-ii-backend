# --------------------------------------------CORRECCION SIMPLIFICADA -- 003------------------------------------------------


# ***************************************
# AgreementsRepository.py -- Ajustado
# ***************************************

import logging
from sqlalchemy.orm import Session
from sqlalchemy import text
from dto.AgreementsDTO import AgreementsListSP  # Importación corregida[cite: 1]
from exceptions import PruebaNotFoundError  #[cite: 1]
