...
from repository import AgreementItemsRepository
from jinja2 import Environment, FileSystemLoader
from dto.AgreementsDTO import AgreementsCreate # corregir nombre 'AgreementsCreate' from 'dto.AgreementsDTO'
...
def generar_pdf_convenio(convenio_db: Agreements, db: DbSession) -> bytes:
    ...
    items_db = AgreementItemsRepository.listar_por_convenio(convenio_db.agreement_id, db)
    items_list = []
