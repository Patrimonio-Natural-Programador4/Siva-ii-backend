...
from controllers import AgreementsControllerAgreements # Para Agreements
...
def register_routes(app: FastAPI):
    ...
    app.include_router( AgreementsControlleragreements.router , dependencies=auth_dependency)
