...
class Agreements(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['region_id'], ['regions_id'], name='agreements_region_id_fkey'),
        ForeignKeyConstraint(['modality_id'], ['agreement_types.id'], name='agreements_agreement_type_id_fkey'),
        ForeignKeyConstraint(['agreement_origin_id'], ['agreement_stages.id'], name='agreements_agreement_stage_id_fkey')
