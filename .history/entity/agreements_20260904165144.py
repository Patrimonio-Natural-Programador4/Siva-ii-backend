...
class Agreements(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['agreement_id'], ['agreements.id'], name='agreements_agreement_id_fkey'),
...
# ==============================================================================
 ...
 # Llave primaria y datos basicos
    ...
    modality: Mapped[Optional[Modalities]] = relationship('Modalities', back_populates='parent_agreement')
    program: Mapped[Optional[Programs]] = relationship('Programs')
    region: Mapped[Optional[Regions]] = relationship('Regions')
    
    agreement_products: Mapped[List['AgreementProducts']] = relationship(
        'AgreementProducts', back_populates='agreement', cascade='all, delete-orphan'
    )
    
    agreement_implementers: Mapped[List['AgreementImplementers']] = relationship(
        'AgreementImplementers', back_populates='agreement', cascade='all, delete-orphan'
    )
