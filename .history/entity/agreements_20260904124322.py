...
# ==============================================================================
    ...
    # Autorreferencia: un acuerdo (otrosí/prórroga/suspensión) puede tener un
    # acuerdo "padre". remote_side indica cuál lado es el padre en la relación.
    parent_agreement: Mapped[Optional['Agreements']] = relationship(
        'Agreements', remote_side=[id], back_populates='child_agreements'
    )
    child_agreements: Mapped[List['Agreements']] = relationship(
        'Agreements', back_populates='parent_agreement'
    )
