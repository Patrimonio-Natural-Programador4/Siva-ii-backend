...
class Agreements(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['capacity_assessment_id'], ['        ForeignKeyConstraint(['capacity_assessment_id'], ['agreement_stages.id'], name='agreements_agreement_stage_id_fkey')
.id'], name='agreements_agreement_stage_id_fkey')
