# -------------------------------------------------------------------------------------------------------------------
# AgreementsRepository.py Refactorizado cambiando logica, entregar al Service -  24 Septiembre 2026 16:18 hrs
# -------------------------------------------------------------------------------------------------------------------
...
# ==============================================================================
from sqlalchemy import BigInteger, ARRAY, DateTime, Integer, Date, Text, ForeignKeyConstraint, PrimaryKeyConstraint, Uuid, Boolean, Numeric, CHAR, Sequence, text
...
# ==============================================================================
    ...
    hectares_beneficiaries_updated_at: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime)    
