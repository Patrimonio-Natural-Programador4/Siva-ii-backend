...
#from controllers import AgreementsController # Para Agreements
...
from controllers import AgreementsControllergreements # Agreegado pruebas Postman Parte 1
...
def register_routes(app: FastAPI):
    ...
    app.include_router( AgreementsControllergreements.router , dependencies=auth_dependency)
    
    # Registrar el módulo de Convenios / Acuerdos 
