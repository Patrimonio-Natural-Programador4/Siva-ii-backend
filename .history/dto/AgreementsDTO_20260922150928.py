...
# --- NUEVA CLASE REQUERIDA POR EL CONTROLLER ---
class AgreementsCreate(AgreementsBase):
    """
    DTO para la creación de un convenio.
    Hereda todos los campos de AgreementsBase.
    """
    pass