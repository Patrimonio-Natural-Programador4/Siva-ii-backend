...
from sqlalchemy import BigInteger, Boolean, CheckConstraint, Column, Date, DateTime, ForeignKeyConstraint, Index, Integer, JSON, LargeBinary, Numeric, PrimaryKeyConstraint, SmallInteger, String, Table, Text, UniqueConstraint, Uuid, text
...
class Modules(Base):
    ...
    acceso_modulos: Mapped[list['AccesoModulos']] = relationship('AccesoModulos', back_populates='modules')
...
class Programs(Base):
    ...
    users_programs: Mapped[list['UsersPrograms']] = relationship('UsersPrograms', back_populates='programs')
...
class Roles(Base):
    ...
    acceso_modulos: Mapped[list['AccesoModulos']] = relationship('AccesoModulos', back_populates='roles')
    model_has_roles: Mapped[list['ModelHasRoles']] = relationship('ModelHasRoles', back_populates='role')
    acceso_controles: Mapped[list['AccesoControles']] = relationship('AccesoControles', back_populates='roles')
...
class AccesoModulos(Base):
    ...
    modules: Mapped['Modules'] = relationship('Modules', back_populates='acceso_modulos')
...
class Controles(Base):
    ...
    modules: Mapped['Modules'] = relationship('Modules', back_populates='controles')
    acceso_controles: Mapped[list['AccesoControles']] = relationship('AccesoControles', back_populates='controles')
...
class AccesoControles(Base):
    ...
    controles: Mapped[Optional['Controles']] = relationship('Controles', back_populates='acceso_controles')
...
class Users(Base):
    ...
    users_programs: Mapped[list['UsersPrograms']] = relationship('UsersPrograms', back_populates='users')
