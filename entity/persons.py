...
class Persons(Base):
 ...
 #relacion simple
    ...
    previous_studies_person:  Mapped[list["PreviousStudies"]] = relationship("PreviousStudies", back_populates="persons") #este nombre debe coincidir con el del otro lado
