"""agregar campos faltantes a list_capacity_assesstment

Revision ID: 25adff2dcef2
Revises: 8a85a7610894
Create Date: 2026-09-08 21:57:07.527287
...
revision: str = '25adff2dcef2'
down_revision: Union[str, Sequence[str], None] = '8a85a7610894'
...
def upgrade():
    ...
    implementer_name citext,
    policy_approval_date date,
    ...
    program_name citext,
    pid_id bigint,
    pad_name character varying,
    persons_id bigint,
    persons_email character varying,
    capacity_assessments_states_id bigint,
    modality_id bigint,
    modality_name character varying,
    pending_my_approval              boolean,
    capacity_assestments_id          integer,
    approval_request_id              bigint,
    user_id                          bigint,
    guid_msft                        uuid,
    step_order_actual_request        integer,
    guid_msft_adjustment              uuid,
